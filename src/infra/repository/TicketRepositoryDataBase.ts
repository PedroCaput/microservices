...
export default class TicketRepositoryDataBase implements TicketRepository{
    async save(ticket: Ticket): Promise<void> {
        ...
        await connection.query("insert into fullcyle.ticket (ticket_id, event_id, email, status) values ($1, $2, $3, $4)", [
    ...
    async update(ticket: Ticket): Promise<void> {
        const connection = pgp()("postgres://postgres:123456@localhost:5432/app");
        await connection.query("update into fullcyle.ticket set status = $1 where ticket_id = $2", [
